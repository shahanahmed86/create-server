...
async function promptForMissingOptions(options) {
	if (options.skipPrompts) {
		return {
			...
			REDIS_USERNAME: options.REDIS_USERNAME || 'redis_username',
			REDIS_PASSWORD: options.REDIS_PASSWORD || 'redis_secret',
	...
	const questions = [
		...
		},
		{
			type: 'input',
			name: 'REDIS_USERNAME',
			message: "Please enter the username of Redis' host where it is serving",
			default: 'redis_username',
		},
		{
			type: 'password',
			name: 'REDIS_PASSWORD',
	...
	return {
		...
		REDIS_USERNAME: options.REDIS_USERNAME || answers.REDIS_USERNAME,
